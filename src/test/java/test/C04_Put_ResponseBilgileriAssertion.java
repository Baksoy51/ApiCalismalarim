...
public class C04_Put_ResponseBilgileriAssertion {
    ...
    public void put01(){
        ...
        String url="https://jsonplaceholder.typicode.com/posts/51";

        JSONObject reqBody= new JSONObject();

        reqBody.put("title","Bunyamin");
        reqBody.put("body","Ne haber");
        reqBody.put("userId","51");
        reqBody.put("id","53");

        System.out.println("ilk yazim: " +reqBody);
